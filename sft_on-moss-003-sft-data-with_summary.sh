...
# pip install -q transformers==4.36.0 # yi-34b-chat
...
torchrun --nproc_per_node=$HOST_GPU_NUM \
    ...
    --model_type auto \
    --template_name yi \
    --model_name_or_path /dockerdata/Yi-6B  \
    --cache_dir /dockerdata/cache \
    --train_file_dir /dockerdata/moss-003-sft-data/ \
    --validation_split_percentage 0.1 \
    --drop_out_of_length_limit_sample True \
    --output_dir /dockerdata/SFT-Yi-6B-${START_TIME}/rank-$INDEX \
